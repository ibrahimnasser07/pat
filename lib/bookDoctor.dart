...
class bookDoctorPage extends StatefulWidget {
  ...
  bookDoctorPage(this.name, this.data, {Key? key}) : super(key: key);

  @override
  State<bookDoctorPage> createState() => _bookDoctorPageState(this.name, this.data);
}
...
class _bookDoctorPageState extends State<bookDoctorPage> {
  ...
  _bookDoctorPageState(this.doctorname, this.doctorData);
  @override
